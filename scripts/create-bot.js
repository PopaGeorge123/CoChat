...
let importOption = ['files-import-option','text-import-option','website-import-option','question-import-option']
let inputTypes = ['files-input-type','text-input-type','website-input-type','question-input-type']
